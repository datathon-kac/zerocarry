...
export class ComponentRequestAgreements extends React.Component {
  gotoNextPage = () => {
    screen.setRequestScreen(RequestScreen.Airplane)
  }

  render() {
    return (
      <div className='c-request-agreements'>
        <ComponentTopRequest
          label='Agreements'
        />
        <div className='c-request-agreements__text'>
